...
- Valgrind 
  - Flag = -g | valgrind ./a.out
  - <details> <summary>More</summary> Valgrind is a powerful tool for detecting memory errors and leaks in your programs. Here's a breakdown of how to use it:
